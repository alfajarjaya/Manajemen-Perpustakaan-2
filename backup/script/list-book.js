...
/*Ini digunakan apabila terdapat gambar pada daftar buku*/
...
editButtonsMobile.forEach(function (button, index) {
    button.addEventListener("click", function () {
        ...
        namaBuku.insertAdjacentHTML("beforeend", bookName);
        document
            .getElementById("nama_buku_image")
...
cancelBtn.addEventListener("click", function () {
    ...
    bookIdInput.removeAttribute("value");
    namaBukuInput.removeAttribute("value");
    namaBuku.innerText = "";
});
